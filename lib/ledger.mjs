...
function renderLedgerHtml(index) {
  ...
  return renderDocument({
    ...
    body: `<main>
  <header class="mast"><a class="northset-brand" href="https://northset.ai">${renderNorthsetWordmark()}</a><p class="northset-domain"><a href="https://northset.ai">NORTHSET.ai</a></p><p class="eyebrow">PUBLIC LEDGER</p><h1>Proof-of-Pass Receipts</h1><p>Each receipt records exactly which declared commands ran, on recorded code and in a recorded environment. It is evidence of that run, not a verdict on code quality or maintainer approval.</p></header>
