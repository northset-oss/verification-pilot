...
function validateStructural(receipt, errors) {
  ...
  if (Object.hasOwn(receipt, 'workspace_mode') && !['readonly', 'writable_copy'].includes(receipt.workspace_mode)) {
    addError(errors, 'WORKSPACE_MODE', '$.workspace_mode', 'must be readonly or writable_copy');
  }
...
function validatePolicy(receipt, errors) {
  ...
  // honesty as a required field, not an optional disclaimer.
