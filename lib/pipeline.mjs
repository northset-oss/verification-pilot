 ...
 *
 * @param {unknown} input
 * @param {{missionsDir: string, siteFile?: string, now?: string, force?: boolean, executeImpl?: typeof execute, ledgerImpl?: typeof buildLedger, renderImpl?: typeof renderLedger, onWarning?: (message: string) => void}} options
